...
if __name__ == '__main__':
    ...
    print("Input file: hrd_input2.txt, output file: hrd_output2.txt")
    os.system("py hrd.py hrd_input2.txt hrd_dfs.txt hrd_output2.txt")
 
    output_read = open("hrd_output2.txt", "r")
    solution_read = open("hrd_solution2.txt", "r")
    ...
    if output_lines[0].startswith("Cost of the solution"):
        ...
        print(
            "First line mismatch. Expected: Cost of the solution, Encountered: " + output_lines[0])
